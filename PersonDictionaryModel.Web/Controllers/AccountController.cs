...
using System;
using PersonDictionaryModel.Core.Model.Models.Auth;
using System.Linq;
...
namespace PersonDictionaryModel.Web.Controllers
{
    public class AccountController : BaseController
    {
        ...
        public AccountController(ICityRepository cityRepo, IMemoryCache memoryCache,
            ...
            IMediatorHandler mediator) : base(memoryCache)
        {
            _cityRepo = cityRepo;
